...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-pak-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6900&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-pak-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-pak` can be installed with:

```
conda install r-pak
```

It is possible to list all of the versions of `r-pak` available on your platform with:
